...
- Distributed dynamic batching already selects metadata-only final flushes when
  stable sample indexes are available; no anydataset integration change is required
